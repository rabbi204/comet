        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <a class="btn btn-primary" data-toggle="modal" href="#category-modal">Add New Category</a>
                    <div class="card">
                                       ...
                                       @foreach($all_data as $data)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a id="category-edit" edit_id="{{ $data -> id }}" class="btn btn-warning btn-sm" data-toggle="modal" href="#category-modal-update">Edit</a>
