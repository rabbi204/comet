...
@section('main-content')
    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <!-- /Page Header -->
   @php
    $all_data = $clients_data -> clients;
    $clients = json_decode($all_data);
   @endphp
                                        ...
                                        <div class="form">
                                            ...
                                            <div class="form-group row add-product">
                                                ...
                                                <div class="col-xl-4 col-sm-4 col-4">
                                                    ...
                                                    <img style="max-height: 100px; width:auto" id="cl1-load" class=" img-fluid mb-3"  src="{{ URL::to('/') }}media/clients/{{ $clients -> cl1 }}" alt="" >
                                                ...
                                                <div class="col-xl-4 col-sm-4 col-4">
                                                    ...
                                                    <img style="max-height: 100px; width:auto" id="cl2-load" class=" img-fluid mb-3"  src="{{ URL::to('/') }}media/clients/{{ $clients -> cl2 }}" alt="" >
                                                    <ul class="file-upload-product">
                                                        <li>
                                                            <div style="background: #333; border-radius: 3px;width: 100px; height: 30px;" class="box-input-file bg-black">
                                                ...
                                                <div class="col-xl-4 col-sm-4 col-4">
                                                    ...
                                                    <img style="max-height: 100px; width:auto" id="cl3-load" class=" img-fluid mb-3"  src="{{ URL::to('/') }}media/clients/{{ $clients -> cl3 }}" alt="" >
                                                    <ul class="file-upload-product">
                                                        <li>
                                                            <div style="background: #333; border-radius: 3px;width: 100px; height: 30px;" class="box-input-file bg-black">
                                                ...
                                                <div class="col-xl-4 col-sm-4 col-4">
                                                    ...
                                                    <img style="max-height: 100px; width:auto" id="cl4-load" class=" img-fluid mb-3"  src="{{ URL::to('/') }}media/clients/{{ $clients -> cl4 }}" alt="" >
                                                    <ul class="file-upload-product">
                                                        <li>
                                                            <div style="background: #333; border-radius: 3px;width: 100px; height: 30px;" class="box-input-file bg-black">
                                                ...
                                                <div class="col-xl-4 col-sm-4 col-4">
                                                    ...
                                                    <img style="max-height: 100px; width:auto" id="cl5-load" class=" img-fluid mb-3"  src="{{ URL::to('/') }}media/clients/{{ $clients -> cl5 }}" alt="" >
                                                    <ul class="file-upload-product">
                                                        <li>
                                                            <div style="background: #333; border-radius: 3px;width: 100px; height: 30px;" class="box-input-file bg-black">
                                                ...
                                                <div class="col-xl-4 col-sm-4 col-4">
                                                    ...
                                                    <img style="max-height: 100px; width:auto" id="cl6-load" class=" img-fluid mb-3"  src="{{ URL::to('/') }}media/clients/{{ $clients -> cl6 }}" alt="" >
                                                    <ul class="file-upload-product">
                                                        <li>
                                                            <div style="background: #333; border-radius: 3px;width: 100px; height: 30px;" class="box-input-file bg-black">
