                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('social.update') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input name="fb" value="{{ $social_data -> fb }}" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">Twitter</label>
                                    <div class="col-lg-9">
                                        <input name="tw" value="{{ $social_data -> tw }}" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">LinkedIn</label>
                                    <div class="col-lg-9">
                                        <input name="lin" value="{{ $social_data -> lin }}" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">Instagram</label>
                                    <div class="col-lg-9">
                                        <input name="ins" value="{{ $social_data -> ins }}" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">Dribble</label>
                                    <div class="col-lg-9">
                                        <input name="drib" value="{{ $social_data -> drib }}" type="text" class="form-control">
                                    </div>
                                </div>
